                    ...
                    <Menu as="div" className="ml-3 relative">
                      <div>
                        <Menu.Button className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                          <span className="sr-only">Open data menu</span>
                          <img className="h-8 w-8 rounded-full" src={data.avatar} alt="" />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
              ...
              <Disclosure.Panel className="sm:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-200">
                  <div className="flex items-center px-4">
                    ...
                    <div className="ml-3">
                      <div className="text-base font-medium text-gray-800">{data.first_name}</div>
                      <div className="text-sm font-medium text-gray-500">{data.email}</div>
                    </div>
                    <button
                      type="button"
